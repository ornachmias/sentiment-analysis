...
class LSTMModel(nn.Module):
    ...
    def forward(self, x):
        ...
        lstm_hidden_state = torch.zeros(self.layer_dim, x.size()[0], self.hidden_dim).requires_grad_()
        # Initialize cell state
        lstm_cell_state = torch.zeros(self.layer_dim, x.size()[0], self.hidden_dim).requires_grad_()
